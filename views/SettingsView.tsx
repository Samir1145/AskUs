        ...
        <div className="flex flex-col h-full bg-gray-50 dark:bg-gray-950">
          ...
          <div className="flex flex-col items-center justify-center flex-1 p-8 text-center animate-in zoom-in duration-300">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-8">
              Your feedback helps us make TacoTribe better. We've received your inputs.
            </p>
            <button
              ...
              <div className="grid grid-cols-3 gap-3 mb-4">
                {['yes', 'partial', 'no'].map((option) => (
                  <button
                    ...
                    className={`py-2 px-3 rounded-lg text-sm font-bold border transition-all capitalize ${feedbackData.reportSatisfaction === option
    ...
    <div className="flex flex-col h-full bg-[#f3f4f6] dark:bg-gray-950">
      ...
      <main className="flex-1 overflow-y-auto pb-4">
        ...
        <div className="mt-4 text-center px-6 pb-6">
          <p className="text-xs text-gray-400 uppercase tracking-widest font-semibold">TacoTribe v1.0.0</p>
        </div>
      </main>
    </div>
  );
